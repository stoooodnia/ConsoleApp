...
namespace ConsoleApp
{
    ...
    public class ImportedObjectAlt : ImportedObjectBaseClassAlt
    {
    ...
    public abstract class ImportedObjectBaseClassAlt
    {
